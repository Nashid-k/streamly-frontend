...
/* ── Player UI shared definitions ────────────────────────────────────
   ...
   The player merges the stored layout over defaults so corrupt/partial
   storage can never break it. */
...
export const PLAYER_UI_SKINS = {
  classic: {
    ...
    btnTone: "frosted",
    progressHeight: "4px",
    progressFill: "var(--accent-gradient, linear-gradient(90deg, #95ff50, #5ce21c))",
    progressGlow: "none",
    timeFont: "-apple-system, BlinkMacSystemFont, 'SF Pro Text', sans-serif",
    accent: "var(--accent-primary, #95ff50)",
...
const DEFAULT_UI_LAYOUT = PLAYER_UI_PRESETS[0].layout;
